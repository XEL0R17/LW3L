...
--
-- Table structure for table `tvcasse`
--

DROP TABLE IF EXISTS `tvcasse`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tvcasse` (
  `id` int NOT NULL AUTO_INCREMENT,
  `marque` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `prix` int DEFAULT NULL,
  `taille` varchar(45) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Dumping data for table `tvcasse`
--

LOCK TABLES `tvcasse` WRITE;
/*!40000 ALTER TABLE `tvcasse` DISABLE KEYS */;
/*!40000 ALTER TABLE `tvcasse` ENABLE KEYS */;
UNLOCK TABLES;
